...
body {
	background-image: url(<?php echo base_url();?>Assets/img/altbg.jpg);
...
<div class="container" >
    <div class="row">
        ...
        <h1 style="color:#fff; font-size:200%;"><span style="font-size:100%; margin-right:10px; margin-top:9px;;" class="glyphicon glyphicon-lock"></span>Reset Password</h1>
        </div>
        <div id="resetcont" class="col-md-12" style="background-color:#fff; border-radius:4px; padding:50px; padding-top:70px; ">
        	<h5 style="color:#cc0000">
                ...
                <br>
                <br>
                Please proceed to the MIS office(5th floor near canteen) to reset your password.
                <br>
                <br>
                Thank you!
