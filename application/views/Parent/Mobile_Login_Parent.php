...
<nav class="navbar navbar-fixed-top" style="display: none">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-toggleable-xs" id="collapseEx">
            <!--Navbar Brand-->
            <a class="navbar-brand waves-effect waves-light" href="#" style="color:#fff; font-family:kalinga">Parent Portal</a>
            <!--Links-->
      ...
      <div class="row" id="home"> 
        ...
        <div class="col-lg-6">
          <div class="description">
            ...
            <a href="http://stdominiccollege.edu.ph/parent_registration/" class="btn btn-primary btn-lg wow fadeInLeft" style="background-color:transparent; font-family:kalinga; border-color: white; border: solid thin;">Registration</a>
             </div>
        </div>
...
<div id="myModal" class="modal fade" role="dialog" tabindex="-1" aria-labelledby="myModal" >
  <div class="modal-dialog" role="document"> 
    ...
    <div class="modal-content" id="login" style="margin-top:150px; color:#666; font-family:kalinga, Geneva, sans-serif; padding:20px;">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Sign in to Parent Portal</h4>
      </div>
      <div class="modal-body">
      <form method="post" action="<?php echo site_url();?>index.php/ParentPortal/Login">
      <label for="ID">Username:</label>
      <input type="text" required class="form-control" id="U_ID" name="U_ID" value="<?php echo set_value('U_ID'); ?>">
      <label for="Password">Password:</label>
      <input type="password" required class="form-control" id="U_Password" name="U_Password" value="<?php echo set_value('U_Password'); ?>">
      <span style="color:#F00; font-size:14px;"></span><?php echo $this->data['message']; ?></br>
      </div>
      <div class="modal-footer">
