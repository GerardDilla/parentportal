...
<div class="container row" id="alignment" style="margin-top:50px; margin-bottom:30px; height:500px; overflow-y:scroll;">
          ...
          <button class="btn center-block" style="margin:auto; margin-bottom:30px; margin-top:20px;" name="submit" type="submit">Search</button>
            </form>
			</div>
