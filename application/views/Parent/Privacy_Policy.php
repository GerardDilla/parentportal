...
<div class="content">
      <div class="row">
            <div class="col-md-12">
                    <div class="card">
                            <div class="card-header">
                               <h4 class="card-title" style="font-weight: 700; color: #800;"> To Continue please the read the following Terms and Conditions:</h4>
                            </div>
                            <hr />
          ...
          <div>
            ...
            <p>
              I <u><strong></strong></u> of legal age, hereby voluntarily and knowingly authorize St. Dominic College of Asia to collect, process or release my personal and sensitive information that may be used for internal and external school official and legal transactions.
            ...
            <hr>
            <input type="checkbox" value="1" name="policyagree" id="agree_check"> I Agree to the Privacy Policy Terms and Conditions <br>
            <hr>
            <a class="btn btn-default" href="<?php echo base_url(); ?>index.php/ParentPortal/Logout">Back</a>
            <button class="btn btn-info" onclick="check_agreement()">Proceed</a>
            <script>
            
            function check_agreement(){
              if($('#agree_check').prop("checked") == true){
                $(location).attr('href', '<?php echo base_url(); ?>index.php/ParentPortal/privacy_policy_accept')
              }else{
                alert('You must agree on the privacy policy terms and conditions to proceed');
              }
            }
